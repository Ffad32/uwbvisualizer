 ...
 *
 * @param {Array} anchors - Array of three anchor positions [{x,y}, {x,y}, {x,y}]
 * @param {Array} distances - Array of three distances [d1, d2, d3] in metres
 * @returns {{x: number, y: number} | null} - Computed tag position or null if degenerate
 */
function trilaterate(anchors, distances) {
    ...
    const [d1, d2, d3] = distances.map(d => parseFloat(d));
